...
#define RefSample_CLASS_ID	Class_ID(0x508622bb, 0xcae9b0e9)
...
public:
	...
	virtual const TCHAR* InternalName() 			{ return _T("Lesson3-SampleRef"); }	// returns fixed parsable name (scripter-visible name)
