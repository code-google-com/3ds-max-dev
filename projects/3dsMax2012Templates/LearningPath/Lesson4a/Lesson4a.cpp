...
#define SampleProCtrl_CLASS_ID	Class_ID(0x8a35ef4d, 0xa8e6afa1)
...
class SampleProCtrlClassDesc : public ClassDesc
{
public:
	...
	const MCHAR* ClassName()		{ static const MSTR str("Lesson4a-Sample Procedural Controller"); return str; }
...
// available to use
ClassDesc* GetSampleProCtrlClassDesc()
{
