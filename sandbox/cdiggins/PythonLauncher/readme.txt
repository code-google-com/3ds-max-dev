...
2) Copy the generated DLL from (obj) to the bin\assemblies folder of 3ds Max 2012.

The next time you run 3ds Max 2012 you will need to open up the Customization dialog and look for the 
command "Run Python script" in the category ".NET Utilities". Assign this to a menu item. 
