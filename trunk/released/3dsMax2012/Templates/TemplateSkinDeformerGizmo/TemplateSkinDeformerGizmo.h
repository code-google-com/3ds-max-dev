...
class TemplateSkinDeformerGizmoClassDesc
    : public ClassDesc2 
{
public: 
    //---------------------------------------
...
class TemplateSkinDeformerGizmo 
    : public AnimatablePlugin<GizmoClass>
{
    //============================================================
    // Fields
    ...
    static const int TemplateSkinDeformerGizmoHeaderChunkID = 1;
...
public:
    ...
    TemplateSkinDeformerGizmo()
		: AnimatablePlugin<GizmoClass>(TemplateSkinDeformerGizmoClassDesc::GetClassDescInstance())
    {         
    ...
    { 
	    IOResult res;
	    isave->BeginChunk(TemplateSkinDeformerGizmoHeaderChunkID);
        
        TODO("Save any member fields");

        res = AnimatablePlugin<GizmoClass>::Save(isave);
    ...
    { 
        ...
        while (iload->OpenChunk() == IO_OK) 
        {
		    ...
		    switch(id)  
            {
			    case TemplateSkinDeformerGizmoHeaderChunkID:
        
                    TODO("Load any member fields");

                    res = AnimatablePlugin<GizmoClass>::Load(iload);
				    break;
			}
		    iload->CloseChunk();
    ...
    {
        ReferenceTarget* r = new TemplateSkinDeformerGizmo();
    ...
    virtual void BaseClone(ReferenceTarget* from, ReferenceTarget* to, RemapDir& remap)  
    {
        ...
        TemplateSkinDeformerGizmo* source = dynamic_cast<TemplateSkinDeformerGizmo*>(from);
        TemplateSkinDeformerGizmo* target = dynamic_cast<TemplateSkinDeformerGizmo*>(to);
        ...
        AnimatablePlugin<GizmoClass>::BaseClone(from, to, remap);
    }

    //=========================================================================
    // AnimatablePlugin<GizmoClass> overrides 
    ...
    {
        return TemplateSkinDeformerGizmoClassDesc::GetClassDescInstance();
    }
