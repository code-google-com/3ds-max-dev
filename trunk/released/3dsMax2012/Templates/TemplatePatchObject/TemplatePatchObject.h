...
class TemplatePatchObjectClassDesc
    : public ClassDesc2 
{
public: 
    //---------------------------------------
...
class TemplatePatchObject 
    : public ObjectPlugin<PatchObject>
{
    //============================================================
    // Fields
    ...
    static const int TemplatePatchObjectHeaderChunkID = 1;
...
public:
    ...
    TemplatePatchObject()
		: ObjectPlugin<PatchObject>(TemplatePatchObjectClassDesc::GetClassDescInstance())
    {         
    ...
    { 
	    IOResult res;
	    isave->BeginChunk(TemplatePatchObjectHeaderChunkID);
        
        TODO("Save any member fields");

        res = ObjectPlugin<PatchObject>::Save(isave);
    ...
    { 
        ...
        while (iload->OpenChunk() == IO_OK) 
        {
		    ...
		    switch(id)  
            {
			    case TemplatePatchObjectHeaderChunkID:
        
                    TODO("Load any member fields");

                    res = ObjectPlugin<PatchObject>::Load(iload);
				    break;
			}
		    iload->CloseChunk();
    ...
    {
        ReferenceTarget* r = new TemplatePatchObject();
    ...
    virtual void BaseClone(ReferenceTarget* from, ReferenceTarget* to, RemapDir& remap)  
    {
        ...
        TemplatePatchObject* source = dynamic_cast<TemplatePatchObject*>(from);
        TemplatePatchObject* target = dynamic_cast<TemplatePatchObject*>(to);
        ...
        ObjectPlugin<PatchObject>::BaseClone(from, to, remap);
    }

    //=========================================================================
    // ObjectPlugin<PatchObject> overrides 
    ...
    {
        return TemplatePatchObjectClassDesc::GetClassDescInstance();
    }
