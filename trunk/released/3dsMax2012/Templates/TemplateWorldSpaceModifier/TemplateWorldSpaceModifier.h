...
class TemplateWorldSpaceModifierClassDesc
    : public ClassDesc2 
{
public: 
    //---------------------------------------
...
class TemplateWorldSpaceModifier 
    : public ModifierPlugin<WSModifier>
{
    //============================================================
    // Fields
    ...
    static const int TemplateWorldSpaceModifierHeaderChunkID = 1;
...
public:
    ...
    TemplateWorldSpaceModifier()
		: ModifierPlugin<WSModifier>(TemplateWorldSpaceModifier::GetClassDesc())
    {         
    ...
    { 
	    IOResult res;
	    isave->BeginChunk(TemplateWorldSpaceModifierHeaderChunkID);
        
        TODO("Save any member fields");

        res = ModifierPlugin<WSModifier>::Save(isave);
    ...
    { 
        ...
        while (iload->OpenChunk() == IO_OK) 
        {
		    ...
		    switch(id)  
            {
			    case TemplateWorldSpaceModifierHeaderChunkID:
        
                    TODO("Load any member fields");

                    res = ModifierPlugin<WSModifier>::Load(iload);
				    break;
			}
		    iload->CloseChunk();
    ...
    {
        ReferenceTarget* r = new TemplateWorldSpaceModifier();
    ...
    virtual void BaseClone(ReferenceTarget* from, ReferenceTarget* to, RemapDir& remap)  
    {
        ...
        TemplateWorldSpaceModifier* source = dynamic_cast<TemplateWorldSpaceModifier*>(from);
        TemplateWorldSpaceModifier* target = dynamic_cast<TemplateWorldSpaceModifier*>(to);
        ...
        ModifierPlugin<WSModifier>::BaseClone(from, to, remap);
    }

    //=========================================================================
    // ModifierPlugin<WSModifier> overrides 

    virtual Deformer* GetDeformer(TimeValue t, ModContext &mc, Matrix3& mat, Matrix3& invmat)
    {
        TODO("Return a deformer object");
        return NULL;
    }
    ...
    {
        return TemplateWorldSpaceModifierClassDesc::GetClassDescInstance();
    }
