...
int TemplateObjectSnapClassDesc::IsPublic() 
{ 
    return 1; 
} 
void* TemplateObjectSnapClassDesc::Create(BOOL loading) 
{ 
...
ClassDesc2* TemplateObjectSnapClassDesc::GetClassDescInstance() 
{
    static TemplateObjectSnapClassDesc desc;
    return &desc;
}
...
{ 
	return "Object Snap template plug-in project."; 
} 
...
{ 
    static TemplateObjectSnapClassDesc classdesc; 
    return &classdesc; 
} 
