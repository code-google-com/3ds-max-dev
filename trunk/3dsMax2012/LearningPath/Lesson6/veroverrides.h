...
#define MAXVER_INTERNALNAME "Lesson6\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Lesson6.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Lesson6 Object Implementation\0"//should  be overidden on a per-dll level
