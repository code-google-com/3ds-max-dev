...
#include "Lesson4b.h"
#define SampleKFCtrl_CLASS_ID	Class_ID(0x8a35ef4b, 0xa8e6afa5)
...
RefResult SampleKFCtrl::NotifyRefChanged(Interval /*changeInt*/, RefTargetHandle /*hTarget*/, PartID& /*partID*/, RefMessage /*message*/)
{
	return REF_DONTCARE;
}
...
class SampleKFCtrlClassDesc : public ClassDesc
{
public:
	...
	const MCHAR* ClassName()		{ static const MSTR str("Lesson4b-Sample Keyframe Controller"); return str; }
	...
	const MCHAR* Category()			{ static const MSTR str("Learning Path"); return str; }
...
ClassDesc* GetSampleKFCtrlClassDesc()
{
